...
@section('title', env("APP_NAME").' - Daftar Pengguna')
    ...
    <div class="container p-b-40">
        <div class="row flex-c">
            <div class="col-11 col-md-8 col-lg-6 bor10 p-tb-24 p-lr-32">
                <h4 class="mtext-109 txt-center m-b-24">Daftar Pengguna</h4>
                @if ($errors->any())
                <div class="p-tb-16 p-lr-24 bor10 m-b-12 alert alert-danger">
                    {{ $errors->first() }}
                </div>
                @endif
                <form action="{{ route('shop.customer.register_process') }}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="bor8 bg0 m-b-12">
                                <input type="text" class="stext-111 cl8 plh3 size-111 p-lr-16" placeholder="Nama Lengkap" name="nama_lengkap">
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="bor8 bg0 m-b-12">
                    ...
                    <hr>
                    <a href="{{ route('shop.customer.login') }}" class="m-t-12 m-b-0 stext-100 m-lr-auto cl6 dis-block">
